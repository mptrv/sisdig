...
<Components>
  ...
  <Vdc V1 1 330 290 -32 -27 1 3 "1 V" 0>
...
<Paintings>
  ...
  <Text 640 320 12 #000000 0 "10k Ω">
  <Text 420 300 12 #000000 0 "20V">
  <Text 290 300 12 #000000 0 "5V">
  <Text 380 200 12 #000000 0 "3k3 Ω">
  <Text 515 240 12 #000000 0 "5k6 Ω">
  <Text 730 320 16 #000000 0 "t_{1} = 0 μs\nt_{2} = 4 μs\nt_{3} = 9 μs">
  <Text 730 295 12 #000000 0 "15 mH">
  <Text 870 200 16 #000000 0 "Cálculos auxiliares:\n\nτ_{1} =                            5 τ_{1} =\n\nτ_{2} =                            5 τ_{3} =\n\nτ_{3} =                            5 τ_{3} =\n\n\\Imáx_{1} =\n\n\\Imáx_{2} =\n\n\\Imáx_{3} =">
</Paintings>
